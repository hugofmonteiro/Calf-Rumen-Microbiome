...
#SBATCH -J Funct_ann                        # JOB ID
#SBATCH -e Diamond.j%j.err                  # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o Diamond.j%j.out                  # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -p -j 128 -s Snakefile_DualRNASeq_diamond.sn --use-conda
