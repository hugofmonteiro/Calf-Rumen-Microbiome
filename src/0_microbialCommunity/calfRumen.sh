...
#SBATCH -J S-Gather                         # JOB ID
#SBATCH -e Sourmash_gather.j%j.err          # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o Sourmash_gather.j%j.out          # STANDARD OUTPUT FILE TO WRITE TO
...
snakemake -p -j 1 -s Snakefile_DualRNASeq_fastgather.sn --use-conda
